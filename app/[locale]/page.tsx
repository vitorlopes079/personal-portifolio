...
export default async function HomePage({ params }: HomePageProps) {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-full py-8 pt-20 md:pt-8">
      ...
      <div className="w-full max-w-4xl px-6 mt-10 md:mt-24 pb-8">
        <ReviewsCarousel locale={locale} seeAllText={translations.Reviews_See_All} />
      </div>
    </div>
  );
}
